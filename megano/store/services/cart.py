...
from .anonym_cart import AnonymCart
...
class CartService:
    ...
    def add_to_cart(self, product, quantity: int, update_quantity=False) -> bool:
        """
    ...
    def get_goods(self) -> Union[OrderProduct, AnonymCart]:
        ...
        if isinstance(self.cart, Order):
            return self.cart.order_products.prefetch_related('product').all()
        return self.cart
